 ...
 */
class ResourcePasswordDescriptionTotpViewModel extends ResourceViewModel {
  /**
   * @constructor
   */
  ...
  static createFromEntity(resourceDto) {
    ...
    return new ResourcePasswordDescriptionTotpViewModel(resourceViewModelDto);
  }
...
export default ResourcePasswordDescriptionTotpViewModel;
