...
/**
 * Model related to the column user account recovery use only with the UI
 */
class ColumnUserAccountRecoveryModel extends ColumnModel {
  /**
   * Constructor
   * @param {Object} columnDto
   */
  constructor(columnDto = {}) {
    columnDto.id = ColumnModelTypes.ACCOUNT_RECOVERY;
    columnDto.field = ColumnFields.USER_ACCOUNT_RECOVERY;
...
export default ColumnUserAccountRecoveryModel;
