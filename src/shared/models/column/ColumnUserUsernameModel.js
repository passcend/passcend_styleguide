...
/**
 * Model related to the column user username use only with the UI
 */
class ColumnUserUsernameModel extends ColumnModel {
  /**
   * Constructor
  ...
  constructor(columnDto = {}) {
    ...
    columnDto.field = ColumnFields.USER_USERNAME;
...
export default ColumnUserUsernameModel;
