...
describe("Entity", () => {
  describe("Entity::constructor", () => {
    ...
    it("works with a reference of the provided dto if clone option is set to false", () => {
      const dto = {a: 1, b: {c: 2}};
      const entity = new Entity(dto, {clone: false});
      dto.a = 3;
      dto.b.c = 4;
      expect(entity._props).toEqual({a: 3, b: {c: 4}});
    });
  });

  describe("Entity::toDto", () => {
    it("stringify as dto", () => {
      const dto = {a: 1, b: {c: 2}};
      const entity = new Entity(dto);
  ...
  describe("Entity::_normalizePropName", () => {
