...
class SecretsCollection extends EntityV2Collection {
   ...
   * @throws {EntityCollectionError} Build Rule: Ensure all items in the collection has unique id
   */
  ...
  /**
   * Returns true if all secret have data decrypted.
   * @returns {boolean}
   */
  ...
  /**
   * Returns true if all secret have data encrypted.
   * @returns {boolean}
   */
