...
/**
 * The DisplayResourcesWorkspaceFilters component represented as a page
 */
export default class DisplayResourcesWorkspaceFiltersPage {
  /**
   * Default constructor
   ...
   */
  exists() {
    return this.filterResources !== null;
  }
}
