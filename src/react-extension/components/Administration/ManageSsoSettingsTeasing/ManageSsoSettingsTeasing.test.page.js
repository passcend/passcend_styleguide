...
/**
 * The ManageSsoSettingsTeasing component represented as a page
 */
export default class ManageSsoSettingsTeasingPage {
  /**
   * Default constructor
  ...
  /**
   * Returns the SSO settings parent class
   * @returns {HTMLElement}
   */
  get ssoSettings() {
  ...
  /**
   * Returns the SSO page First Line element
   * @returns {HTMLElement}
   */
   ...
   */
  get upgradeButton() {
    return this._page.container.querySelector(".third-party-provider-settings-info > div > a.button.primary");
  }
