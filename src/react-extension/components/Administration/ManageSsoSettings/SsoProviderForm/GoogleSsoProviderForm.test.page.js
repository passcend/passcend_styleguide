...
/**
 * The GoogleSsoProviderFormPage component represented as a page
 */
export default class GoogleSsoProviderFormPage {
  /**
   * Default constructor
   ...
   */
  get client_id() {
    return this.select("#sso-google-client-id-input");
  }
   ...
   */
  get clientIdError() {
    return this.select("#sso-google-client-id-input + .error-message");
  }
   ...
   */
  get client_secret() {
    return this.select("#sso-google-secret-input");
  }
