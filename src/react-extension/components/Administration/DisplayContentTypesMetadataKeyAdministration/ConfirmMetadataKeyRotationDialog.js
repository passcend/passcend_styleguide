...
class ConfirmMetadataKeyRotationDialog extends React.Component {
  ...
  render() {
    ...
    return (
      <DialogWrapper className='confirm-metadata-key-rotation-dialog' title={this.props.t("Please confirm")} onClose={this.handleCancel} disabled={isDisabled}>
        <div className="form-content">
          <label><Trans>New shared Metadata key</Trans></label>
        ...
        <div className="submit-wrapper clearfix">
          ...
          <button type="button" className="button primary form" onClick={this.handleConfirm} disabled={isDisabled}><Trans>Rotate key</Trans></button>
        </div>
      </DialogWrapper>
    );
  }
