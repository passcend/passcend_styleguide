...
/**
 * The AddUserToGroupDialog component represented as a page
 */
export default class AddUserToGroupDialogPage {
  /**
   * Default constructor
   ...
   */
  setupPageObjects() {
    this._displayAddUserToGroupDialog = new AddUserToGroupDialogPageObject(this._page.container);
  }

  /**
   * Returns the page object of display comments
   */
  get displayAddUserToGroupDialog() {
    return this._displayAddUserToGroupDialog;
  }
}
 ...
 */
class AddUserToGroupDialogPageObject {
  /**
   * Default constructor
   * @param container The container which includes the add user to group dialog Component
   */
