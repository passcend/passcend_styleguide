...
/**
 * The RemoveUserFromGroup component represented as a page
 */
export default class RemoveUserFromGroupPage {
  /**
   * Default constructor
   ...
   */
  setupPageObjects() {
    this._displayRemoveUserFromGroupDialog = new RemoveUserFromGroupDialogPageObject(this._page.container);
  }

  /**
   * Returns the page object of display comments
   */
  get displayRemoveUserFromGroupDialog() {
    return this._displayRemoveUserFromGroupDialog;
  }
}
 ...
 */
class RemoveUserFromGroupDialogPageObject {
  /**
   * Default constructor
   * @param container The container which includes the remove user from group dialog Component
   */
